export const payoutRejectTemplate = () => {
...
@media (max-width:441px)  { 
  ...
  <body style="word-spacing:normal;background-color:#eeeeee;">
      ...
      >We’re reaching out to let you know that your recent payout request was not successful. This may be due to an issue with your account details or eligibility requirements.  
</br></br>
    Please review your payout request and ensure all details are accurate. If you need assistance or have any questions, our support team is here to help. 
</br></br>
Contact Us: help@huntgrounds.com  
